...
<head>
    ...
    <title>NeBank</title>
    <style><%@include file="/WEB-INF/css/Wallet/deletewallet.css"%></style>
</head>
<body>
<header>
    ...
    <div class="head-lower">
        <div class="head-lower-name">Удаление</div>
...
<section>
    <form class="reg" method="post">
        <div class="text">Вы уверены, что хотите удалить кошелёк - ${sessionScope.wallet.wallet_name}?</div>
        <button type="submit" style="display: inline-block;" name="delete" value="delete">Удалить кошелёк</button>
    </form>
