...
<head>
    ...
    <title>NeBank</title>
    <style><%@include file="/WEB-INF/css/Wallet/depositwallet.css"%></style>
</head>
<body>
<header>
    ...
    <div class="head-lower">
        <div class="head-lower-name">Пополнение кошелька - ${sessionScope.wallet.wallet_name}</div>
        <div class="create"><a href="${pageContext.request.contextPath}/wallet"><button type="button">Вернуться назад</button></a></div>
    </div>
</header>
<section>
    <form class="reg" method="post">
        <p><input type="number" name="amount_money" placeholder="Введите сумму" autocomplete="off"/></p>
        <p>
            <button type="submit" style="display: inline-block;">Пополнить</button>
        </p>
    </form>
